...
def parse_chunk_filename(filename: str) -> Tuple[Optional[int], Optional[int], Optional[int]]:
...
def run_validation(docling_json: Path, chunks_dir: Path, verbose: bool = False) -> Tuple[bool, Dict[str, Any]]:
    """
